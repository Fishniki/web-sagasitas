      ...
      <Carousel className="h-full">
        <div className="relative w-full h-screen border flex">
          ...
          <div className="absolute top-0 left-0 ml-5 md:ml-20 flex flex-col justify-center items-start w-full h-screen px-5 md:px-20">
            ...
            {isOpen && (
              <div className="max-w-96 md:max-w-[500px] max-h-[80vh] text-start mb-5 font-roboto p-5 bg-sky-500 bg-opacity-15 rounded-md overflow-y-auto">
                  Satu dari 12 anak dibawah usia lima tahun di Indonesia mengalami wasting dan satu dari lima mengalami stunting.
                  ...
                  Kedua bentuk kekurangan gizi ini memiliki dampak buruk dan mengancam kesehatan, kehidupan dan perkembangan jangka panjang pada bayi dan anak di seluruh Indonesia.
              </div>
            )}
            <button
